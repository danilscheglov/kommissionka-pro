...
export const advantages = [
  ...
  },
  {
    ...
    title: 'Комиссия',
    description:
      'Принимаем технику на комиссию в разумные сроки, на прозрачных и понятных условиях.',
    highlight: 'Принимаем технику на комиссию в разумные сроки',
    note: 'Заранее озвучиваем условия, помогаем с размещением и сопровождаем продажу без лишней бюрократии.',
    badge: `
      <svg viewBox="0 0 24 24" aria-hidden="true" fill="none">
